...
})({"hK5zL":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "69f74e7f31319ffd";
module.bundle.HMR_BUNDLE_ID = "d6fec658274802c0";
"use strict";
...
},{}],"4Tjiz":[function(require,module,exports) {
"use strict";
/**
...
function getPem(filename, callback) {
    if (callback) getPemAsync(filename).then((pem)=>callback(null, pem)
    ).catch((err)=>callback(err, null)
    );
    else return getPemAsync(filename);
}
 ...
 */ function convertToPem(p12base64) {
    ...
    if (bags.friendlyName) {
        ...
        return pem.replace(/\r\n/g, '\n');
    } else throw new Error('Unable to get friendly name.');
} //# sourceMappingURL=index.js.map

},{"fs":"8VSUO","node-forge":"lIR0L","util":"jtUga"}]},["hK5zL"], null, "parcelRequiree86c")

//# sourceMappingURL=build.274802c0.js.map
